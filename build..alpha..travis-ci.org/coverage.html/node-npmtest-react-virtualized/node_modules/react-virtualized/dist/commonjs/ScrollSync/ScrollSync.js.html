...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-virtualized/node_modules/react-virtualized/dist/commonjs/ScrollSync/ScrollSync.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-react-virtualized/node_modules/react-virtualized/dist/commonjs/ScrollSync/ScrollSync.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-virtualized/node_modules/react-virtualized/dist/commonjs/ScrollSync/</a> &#187; ScrollSync.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function ScrollSync(props, context) {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, ScrollSync);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _this = _possibleConstructorReturn(this, (ScrollSync.__proto__ || Object.getPrototypeOf(ScrollSync)).call(this, props, context));</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      return children({</span>
    ...
    key: '_onScroll',
    value: <span class="fstat-no" title="function not covered" >function _onScroll(_ref) {</span>
<span class="cstat-no" title="statement not covered" >      var clientHeight = _ref.clientHeight,</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.setState({ clientHeight: clientHeight, clientWidth: clientWidth, scrollHeight: scrollHeight, scrollLeft: scrollLeft, scrollTop: scrollTop, scrollWidth: scrollWidth });</span>
    }
  }]);
&nbsp;
  return ScrollSync;
