...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-virtualized/node_modules/react-virtualized/dist/commonjs/Masonry/PositionCache.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-react-virtualized/node_modules/react-virtualized/dist/commonjs/Masonry/PositionCache.js</span></h1>
    <h2>
        
        Statements: <span class="metric">33.73% <small>(28 / 83)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-virtualized/node_modules/react-virtualized/dist/commonjs/Masonry/</a> &#187; PositionCache.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >  function PositionCache() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, PositionCache);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    this._columnSizeMap = {};</span>
<span class="cstat-no" title="statement not covered" >    this._intervalTree = (0, _intervalTree2.default)();</span>
<span class="cstat-no" title="statement not covered" >    this._leftMap = {};</span>
  }
...
&nbsp;
  _createClass(PositionCache, [{
    ...
    value: <span class="fstat-no" title="function not covered" >function estimateTotalHeight(cellCount, columnCount, defaultCellHeight) {</span>
<span class="cstat-no" title="statement not covered" >      var unmeasuredCellCount = cellCount - this.count;</span>
<span class="cstat-no" title="statement not covered" >      return this.tallestColumnSize + Math.ceil(unmeasuredCellCount / columnCount) * defaultCellHeight;</span>
    }
&nbsp;
...
&nbsp;
    ...
    key: 'range',
    value: <span class="fstat-no" title="function not covered" >function range(scrollTop, clientHeight, renderCallback) {</span>
<span class="cstat-no" title="statement not covered" >      var _this = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      this._intervalTree.queryInterval(scrollTop, scrollTop + clientHeight, <span class="fstat-no" title="function not covered" >function (_ref) {</span></span>
<span class="cstat-no" title="statement not covered" >        var _ref2 = _slicedToArray(_ref, 3),</span>
            top = _ref2[0],
            _ = _ref2[1],
            index = _ref2[2];
&nbsp;
<span class="cstat-no" title="statement not covered" >        return renderCallback(index, _this._leftMap[index], top);</span>
      });
    }
  }, {
    key: 'setPosition',
    value: <span class="fstat-no" title="function not covered" >function setPosition(index, left, top, height) {</span>
<span class="cstat-no" title="statement not covered" >      this._intervalTree.insert([top, top + height, index]);</span>
<span class="cstat-no" title="statement not covered" >      this._leftMap[index] = left;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var columnSizeMap = this._columnSizeMap;</span>
<span class="cstat-no" title="statement not covered" >      var columnHeight = columnSizeMap[left];</span>
<span class="cstat-no" title="statement not covered" >      if (columnHeight === undefined) {</span>
<span class="cstat-no" title="statement not covered" >        columnSizeMap[left] = top + height;</span>
      } else {
<span class="cstat-no" title="statement not covered" >        columnSizeMap[left] = Math.max(columnHeight, top + height);</span>
      }
    }
  }, {
    key: 'count',
    get: <span class="fstat-no" title="function not covered" >function get() {</span>
<span class="cstat-no" title="statement not covered" >      return this._intervalTree.count;</span>
    }
  }, {
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      for (var i in columnSizeMap) {</span>
<span class="cstat-no" title="statement not covered" >        var height = columnSizeMap[i];</span>
<span class="cstat-no" title="statement not covered" >        size = size === 0 ? height : Math.min(size, height);</span>
      }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      for (var i in columnSizeMap) {</span>
<span class="cstat-no" title="statement not covered" >        var height = columnSizeMap[i];</span>
<span class="cstat-no" title="statement not covered" >        size = Math.max(size, height);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      return size;</span>
    }
